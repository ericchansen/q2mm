...
class TestRegisteredEngines:
    ...
    def test_discover_registers_all_mm_engines(self):
    ...
    def test_discover_registers_qm_engines(self):
        engines = registered_qm_engines()
        assert "psi4" in engines

    def test_registered_engines_has_all(self):
...
class TestAvailableEngines:
    ...
    def test_available_qm_engines_subset_of_available(self):
...
class TestGetEngine:
    ...
    def test_get_mm_engine_unknown_raises(self):
        with pytest.raises(EngineNotAvailable):
            get_mm_engine("not-a-real-engine")

    def test_get_qm_engine_unknown_raises(self):
        with pytest.raises(EngineNotAvailable):
...
class TestCheckAvailable:
    ...
    def test_check_available_with_broken_class(self):
        class BrokenEngine:
    ...
    def test_check_available_with_unavailable_class(self):
