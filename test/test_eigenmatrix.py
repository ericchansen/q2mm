...
class TestTransformToEigenmatrix:
    def test_self_projection_is_diagonal(self, symmetric_matrix):
    ...
    def test_different_hessian_not_diagonal(self, symmetric_matrix):
    ...
    def test_roundtrip_consistency(self, symmetric_matrix):
...
class TestReferenceDataEigenvalues:
    def test_add_hessian_eigenvalue(self):
    ...
    def test_add_hessian_offdiagonal(self):
    ...
    def test_add_eigenmatrix_from_hessian_diagonal_only(self):
    ...
    def test_add_eigenmatrix_from_hessian_full(self):
    ...
    def test_weight_scheme_skip_first(self):
    ...
    def test_weight_scheme_custom(self):
    ...
    def test_from_molecule_with_eigenmatrix(self):
...
class TestObjectiveFunctionEigenmatrix:
    def test_extract_eig_diagonal(self):
    ...
    def test_extract_eig_offdiagonal(self):
