...
def test_catalog_reports_all_descriptors() -> None:
    ...
    assert {"openmm", "tinker", "jax", "jax-md", "psi4", "qcengine", "ase"} <= names
...
def test_catalog_is_lazy_in_fresh_interpreter() -> None:
    ...
    code = (
        ...
        "statuses = r.catalog()\n"
        "assert statuses\n"
        "for m in ('jax', 'jaxlib', 'openmm', 'qcengine', 'qcelemental', 'ase',\n"
        ...
        "          'q2mm.backends.reference.qcengine', 'q2mm.backends.reference.ase'):\n"
