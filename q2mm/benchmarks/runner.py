...
from q2mm.benchmarks import acceptance, analysis, artifacts, profiles, records
...
def _execute(
    *,
    ...
    if is_jax_backend:
        ...
        ratio_info = acceptance.classify_ratio(ratio, profile.executor_ratio_tol)
    ...
    summary.update(
        analysis._score_interval_summary(
