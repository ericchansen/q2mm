"""Pd 1,4-conjugate-addition publication case study."""
...
CONFIG = _RUNNER.PublicationExample(
    ...
    note="Ten-case compatibility profile; source electrostatic, torsion, and equilibrium-tether terms remain blocked.",
)


def run(**kwargs: Any) -> dict[str, Any]:
    """Run the ten-case Pd-conjugate profile."""
