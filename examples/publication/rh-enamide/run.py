"""Rh-enamide publication case study."""
...
CONFIG = _RUNNER.PublicationExample(
    ...
    required_roots=("rh_enamide",),
    note="Nine-case geometry/eigenmatrix compatibility profile; source ESP-charge and relative-enthalpy terms are omitted.",
)


def run(**kwargs: Any) -> dict[str, Any]:
    """Run the source-backed Rh-enamide case."""
