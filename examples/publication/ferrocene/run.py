"""Wahlers Chapter 4 Ferrocene ground-state case study."""
...
CONFIG = _RUNNER.PublicationExample(
    ...
    default_starting_point="published",
    objective_profile="wahlers-ferrocene-seven-structure-v1",
    fc_fraction=None,
    eq_fraction=None,
    note=(
        "Published-only seven-ground-state profile. Four numerical scans are absent, "
        "and QFUERZA is blocked until D1 dummy topology/frozen membership is proven."
    ),
)


def run(**kwargs: Any) -> dict[str, Any]:
    """Run the seven-case published-start Ferrocene profile."""
