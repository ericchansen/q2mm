"""Heck-relay publication case study."""
...
CONFIG = _RUNNER.PublicationExample(
    key="heck-relay",
    expected_status="executable_archive_reproduction",
    required_roots=("supporting_info",),
    fc_fraction=0.05,
    note="The deposited 23-case row is executable; the described 24-case row is blocked by missing prrts1.",
)


def run(**kwargs: Any) -> dict[str, Any]:
    """Run the 23-case Heck archive profile with its 5% force-constant bound."""
