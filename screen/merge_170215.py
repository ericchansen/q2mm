...
def copy_rca4(merge, struct_1, match_1, struct_2, match_2):
    """
...
def main(opts):
    ...
    # Add chirality information to title/name if any exists.
    structures = add_chirality(structures)
