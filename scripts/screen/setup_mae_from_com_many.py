...
def return_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        help="Name(s) of *.com file(s) that you'd like to generate *.mae file(s) for.",
    )
    parser.add_argument(
        "-s", "--suffix", type=str, metavar="string", help='Adds "string" to the end of the created *.com files.'
    )
    return parser
