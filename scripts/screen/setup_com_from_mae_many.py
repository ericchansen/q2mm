...
def main(opts):
    ...
    for file_input in opts.input:
        ...
        if opts.jobtype == "cs":
            com_setup.my_mcmm(mae_file=file_input, com_file=name + ".com", out_file=name + ".mae", nsteps=opts.nsteps)
        elif opts.jobtype == "mini":
            com_setup.my_mini(mae_file=file_input, com_file=name + ".com", out_file=name + ".mae")
        elif opts.jobtype == "re":
            com_setup.my_conf_elim(mae_file=file_input, com_file=name + ".com", out_file=name + ".mae")
