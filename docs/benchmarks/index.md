...
| [Optimizer Comparison](optimizer-comparison.md) | Compare the production SciPy L-BFGS-B + JAX executor path on literature-scale TS systems | Historical endpoint reductions for four systems; executor-specific uncertainty and local-basin limits are explicit |
