...
|------|------------------|---------------|--------|
| [Small Molecules](small-molecules.md) | How do the supported backend/form/optimizer combinations compare on a tractable system? | Full CH₃F matrix: 44 supported combos across JAX, JAX-MD, OpenMM, and Tinker (including optax optimizers) | **Complete** |
